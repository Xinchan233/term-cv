...
用法：
python collectingfaces.py --id 106 --imagedir /home/zhangxinchan/PycharmProjects/term-cv/oldcare/images
...
audioplayer.play_audio(os.path.join(audio_dir, 'fall.mp3'))
# 释放全部资源
cam.release()
